...
<body>
        ...
        <fieldset>
            ...
            <p>
                <span>
                    ...
                    <label for="input_username_error" id="input_usernameError" style="color: red;"><?php echo $UsernameError; ?></label>
                </span>
            </p>
            ...
            <p>
                <span>
                    ...
                    <label for="input_password_error" id="input_passwordError" style="color: red;"><?php echo $PasswordError; ?></label>
                </span>
            </p>
    ...
    <script src="./Controllers/js/js-validation-login.js"></script>
</body>
